      ...
      <header>
        <div className="intro-content">
          ...
          <div className="cta-buttons">
            <a href="./destinations.html" className="cta-btn lang-text" data-lang="explore_now">Explore Destinations Now</a>
            <a href="./services.html" className="cta-btn lang-text" data-lang="request_services">Request Our Services</a>
          </div>
        </div>
      </header>
